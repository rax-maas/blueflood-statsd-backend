...
function StaticTenantBackend(tenantId, endpoint, flushInterval, log) {
  ...
  var self = this;
	...
	blueflood_http_client.authenticate("asd","asd","asd",auth_callback);
}

StaticTenantBackend.prototype.init = function(startup_time, config, events) {
} 
