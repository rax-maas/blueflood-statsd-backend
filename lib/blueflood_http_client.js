 ...
 */
function buildPayloads(tenantId, timestamp, gauges, counters, timers, sets, max) {
  var payloads = [],
      basePayload = {
        tenantId: tenantId,
        timestamp: timestamp,
...
function postMetrics(
  ...
  var payloads = buildPayloads(tenantId, timestamp, gauges, counters, timers, sets, MAX_JSON_SIZE),
