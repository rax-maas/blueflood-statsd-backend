...
exports.init = function (startupTime, config, events, logger) {
  ...
  if (bfConfig.username != null && bfConfig.key != null) {
  	endpoint = "http://cloudmetrics.staging.endpoint:19000";
  }
  globalBackend = new StaticTenantBackend(bfConfig.tenantId, endpoint, flushIntervalMillis, realLogger, bfConfig.username, bfConfig.key);
