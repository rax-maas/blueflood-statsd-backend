...
var logAll = false;
var cmendpoint = "https://global.metrics-ingest.api.rackspacecloud.com";
...
exports.init = function (startupTime, config, events, logger) {
  ...
  if (bfConfig.hasOwnProperty('globalPrefix')) {
    globalPrefix = bfConfig.globalPrefix;
  }
  ...
  globalBackend = new StaticTenantBackend(bfConfig.tenantId, endpoint, flushIntervalMillis, realLogger, bfConfig.maxjsonsize, auth, globalPrefix);
